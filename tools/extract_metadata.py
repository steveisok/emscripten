...
def data_to_string(data):
  ...
  # backslash in order to represent a single backslash since these
  # string historically were written and read back via JSON and
  # single slash is interpreted as an escape char there.
